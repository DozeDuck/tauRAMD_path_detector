...
os.system("c=`more md_noPBC_fit.pdb | grep TITLE | tail -100 | awk '{print $6}' | head -1`; printf '0\n' | gmx trjconv -s md_noPBC_fit.pdb -f md_noPBC_fit.pdb -b $c -o last100_skip2_.pdb -skip 2")
